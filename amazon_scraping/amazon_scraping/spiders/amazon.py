...
#import sqlite3
#from sqlite3 import Cursor, SQLITE_CREATE_TABLE
    ...
    def parse_product_page(self, response):
        ...
        if price != 'null':
         ...
         #   price = response.xpath('//*[@data-asin-price]/@data-asin-price').extract_first() or \
          #          response.xpath('//*[@id="priceblock_ourprice"]/text()').extract_first()
...
#client = pymongo.MongoClient("mongodb+srv://robertoartiaco:<filippino96>@cluster0.idazu.mongodb.net/Project0?retryWrites=true&w=majority")
#db = client.test